...
const genericOperations: ContractOperation[] = [
  ...
  { operationId: 'readApplicationRecordFileByIndex', title: 'Read one file of a files field', method: 'GET', template: '/api/v1/{collectionName}/{recordId}/files/{fieldName}/{fileIndex}', authOnly: false, requiresSession: false, accept: '*/*' },
